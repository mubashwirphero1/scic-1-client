...
const Contact = () => {
    return (
        <>
            <Navigation />
            <div className="pt-20 sm:mt-0 mx-10">
                                    ...
                                    <div className="grid grid-cols-6 gap-6">
                                        <div className="col-span-6 sm:col-span-3">
                                            ...
                                            <input
                                                ...
                                                className="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-md border-gray-500 rounded-sm"
                                            />
                                        </div>

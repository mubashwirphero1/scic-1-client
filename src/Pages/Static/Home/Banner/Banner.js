...
const Banner = () => {
    return (
        <div className={`${styles.banner} flex flex-row gap-3 items-center py-36 px-4`}>
            <div>
                <h1 className={` ${styles.bannerH} font-black lg:text-4xl md:text-2xl sm:text-2xl text-white`}>WE PROVIDE THE BEST QUALITY PRODUCTS <br /> WHICH ACCOMMODATE WITH YOUR NEEDS</h1>
                <br />
